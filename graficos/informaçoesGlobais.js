...
async function visualizarInformacoesGlobais() {
    ...
    const porcentagemConectadas = ((pessoaConectadas/pessoasNoMundo)*100).toFixed(2)
    ...
    <br> Isso significa que aproximadamente ${porcentagemConectadas}% de pessoas estâo conectadas em alguma rede social.`
